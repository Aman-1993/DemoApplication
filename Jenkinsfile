...
pipeline {
    ...
    stages {
		...
		sh "ssh dockeradmin@${ENVIRONMENT} 'rm -rf /home/dockeradmin/*'"
                sh "scp -r /var/lib/jenkins/workspace/temp-pipeline_dev/DemoApplication/target/demo.war /var/lib/jenkins/workspace/temp-pipeline_dev/Dockerfile dockeradmin@${ENVIRONMENT}:/home/dockeradmin"
